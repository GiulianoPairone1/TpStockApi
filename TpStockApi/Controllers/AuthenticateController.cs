...
namespace TpStockApi.Controllers
{
    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        public IActionResult Authenticate([FromBody] CredentialsDto credentialsDto)
        {
            ...
            claimsForToken.Add(new Claim("given_name", validationResponse.Item2.FullName)); //Lo mismo para given_name y family_name, son las convenciones para nombre y apellido. Ustedes pueden usar lo que quieran, pero si alguien que no conoce la ap
